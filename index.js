...
function createUserBox(user) {
    ...
    dollar_span.innerHTML = user.price
    text_p.innerHTML = user.description
    text_h1.innerHTML = user.category
    img.src = user.image
    dollar.src = './img/dollar.svg'
    ...
    img.alt = 'img'
    star_span.innerHTML = user.rating.rate
    box_span.innerHTML = user.rating.count
    button.innerHTML = 'В избранное' 

    
    box_div.append(img_div, text_div)
    img_div.append(img)
    text_div.append(text_h1, text_p, img_svg, center)
    img_svg.append(dollar, dollar_span, star, star_span, box, box_span)
